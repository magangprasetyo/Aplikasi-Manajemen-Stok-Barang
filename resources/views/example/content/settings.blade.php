            ...
            <div
                ...
                <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                    <img class="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0"
                        src="{{ asset('static/images/users/bonnie-green-2x.png') }}" alt="Jese picture">
                    <div>
                                ...
                                <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                    <div>
                                        <img class="w-6 h-6 rounded-full"
                                            src="{{ asset('static/images/users/bonnie-green.png') }}" alt="Bonnie image">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <p
                        ...
                        <li class="py-4">
                            <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                                <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                    <div>
                                        <img class="w-6 h-6 rounded-full"
                                            src="{{ asset('static/images/users/jese-leos.png') }}" alt="Jese image">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <p
                                            class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
                        ...
                        <li class="py-4">
                            <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                                <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                    <div>
                                        <img class="w-6 h-6 rounded-full"
                                            src="{{ asset('static/images/users/thomas-lean.png') }}" alt="Thomas image">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <p
                                            class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
                        ...
                        <li class="pt-4">
                            <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                                <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                    <div>
                                        <img class="w-6 h-6 rounded-full"
                                            src="{{ asset('static/images/users/lana-byrd.png') }}" alt="Lana image">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <p
                                            class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
                ...
                <div class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <div class="flex items-center justify-between py-4">
                        <div class="flex flex-col flex-grow">
                            ...
                            <div class="text-base font-normal text-gray-500 dark:text-gray-400">Get important notifications
                ...
                <div class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <div class="flex items-center justify-between py-4">
                        <div class="flex flex-col flex-grow">
                            ...
                            <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send an email reminding me
