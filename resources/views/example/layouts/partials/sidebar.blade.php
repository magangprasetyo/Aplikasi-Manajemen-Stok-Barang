        ...
        <ul class="pb-2 space-y-2">
          ...
          <li>
            ...
            <ul id="dropdown-crud" class="space-y-2 py-2 {{ Request::is('crud/*') ? 'block' : 'hidden' }}">
              <li>
                <a href="{{ url('example/crud/products') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('crud/products') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Products
                </a>
              </li>
              <li>
                <a href="{{ url('example/crud/users') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
          ...
          <li>
            <a href="{{ url('example/settings') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug == 'settings' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
          ...
          <li>
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                ...
                <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Supplier</span>
          ...
          <li>
            ...
            <ul id="dropdown-playground" class="space-y-2 py-2 {{ Request::is('playground/*') ? 'block' : 'hidden' }}">
              <li>
                  <a href="{{ url('example/playground/stacked') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">
                      Stacked
                  </a>
              </li>
              <li>
                <a href="{{ url('example/playground/sidebar') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('example/playground/sidebar') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                    Sidebar
                </a>
            </li>
          </ul>
