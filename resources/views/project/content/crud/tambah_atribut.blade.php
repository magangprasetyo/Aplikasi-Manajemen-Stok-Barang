...
@section('content')
    <div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
        {{-- Tambah Atribut Product Data --}}
        <div class="col-span-2">
            <div
                class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <h3 class="mb-4 text-xl font-semibold dark:text-white">Tambah Atribut Product</h3>
                <form action="{{ route('createProductAttribute') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <select name="product_id" id="product_id"
                                ...
                                @foreach ($produck as $produck)
                                    <option value="{{ $produck->id }}">{{ $produck->name }}</option>
                                @endforeach
                            </select>
                        </div>
